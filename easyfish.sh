...
banner() {
	cat <<- EOF
,,'''''.  .....'',,;;:::::;c:::::;'...':okNW0l,.......'',,;,'';:::c
''.''''.  ...';,;,;oc:::cccc:::;;......;:cdWWW0c,.......'',:clodkOc
'''''.   ....':;;:lxc:::lcooollc,......;oxXKNWWO00l;.....',,,,;:cc,
..'..    ....':c:oll:locdlxxxxx:....',;dxxkdk0Xko0X0:........''',,,
...       . ..:ccddxdlxcxddxxo,...','..cdoxooddoldO0d''......''',;,
''.   .. ......,:loxxdxxxxddl.  .......lxdddddxoll:c:;,,,....'',,,'
...............,;;:coddxxxdo,       ...okkxxxdoollc:cc:','.....',;:
.. ..''l,.:o,;...',cxddkxlo;         .,dkkklodloccc::c:;,,....',,,,
.. ..';ol,okc;'...':o,,cll;          .cxkkkkod:oclcol:;:;;,........
.....,;ccocd;.'.....'.';:,      .    .cxdxxodollclll:;;;:;''.'.'''.
....';;coxk:;;:......,;:;            'loclc::lll,'::ll;;;,'....''''
....';:cc,:cc::.';.'.':'.            :l:,,clc::;'';c',::;''........
....,;,:l;;;;:l:,cc;';:.           ..cc;,';;,,;,.,,.',,,'..'...,'''
.....;;::;:::,c;;loo:cc.           ,::.'..',.,;:,'....,'..'..,,,'''
'','.';;::;c:cllccoolcc           'lc,''..':;olc;'....,'... ',,,'''
',;:,.':;::cll:::;llll:          'ol;,...';:odo:,....''...  ..,'''.
..';::..;;:lllll:;:clc,         :lolcc;;:col:cc:cc,''....  .  .....
...';lc..,::cccclccclc'      .'looododooxddxdlc:::::;,..  .'.. .',,
...',:cc'..';:::cccc:l:.    .cddxxddddxoodddlc::;;,,'....'',,'..,,,
..'',;;;,,....',;:::::;....;oooooodddododolcccc;;,'.. .',,,
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Hacker clown (sani kushwah)${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
     ...
     ${BLUE}        ''.  ...';,;,;oc:::cccc:::;;......;:cdWWW0c,.......'',:clodkOc
     ${BLUE}   '''''.   ....':;;:lxc:::lcooollc,......;oxXKNWWO00l;.....',,,,;:cc,
     ${BLUE}   ..'..    ....':c:oll:locdlxxxxx:....',;dxxkdk0Xko0X0:........''',,,
     ${BLUE}   ...       . ..:ccddxdlxcxddxxo,...','..cdoxooddoldO0d''......''',;,
     ${BLUE}   ''.   .. ......,:loxxdxxxxddl.  .......lxdddddxoll:c:;,,,....'',,,'
     ${BLUE}   ...............,;;:coddxxxdo,       ...okkxxxdoollc:cc:','.....',;:
     ${BLUE}   .. ..''l,.:o,;...',cxddkxlo;         .,dkkklodloccc::c:;,,....',,,,
     ${BLUE}   .. ..';ol,okc;'...':o,,cll;          .cxkkkkod:oclcol:;:;;,........
     ${BLUE}   .....,;ccocd;.'.....'.';:,      .    .cxdxxodollclll:;;;:;''.'.'''.
     ${BLUE}   ....';;coxk:;;:......,;:;            'loclc::lll,'::ll;;;,'....''''
     ${BLUE}   ....';:cc,:cc::.';.'.':'.            :l:,,clc::;'';c',::;''........
     ${BLUE}   ....,;,:l;;;;:l:,cc;';:.           ..cc;,';;,,;,.,,.',,,'..'...,'''
     ${BLUE}   .....;;::;:::,c;;loo:cc.           ,::.'..',.,;:,'....,'..'..,,,'''
     ${BLUE}   '','.';;::;c:cllccoolcc           'lc,''..':;olc;'....,'... ',,,'''
     ${BLUE}   ',;:,.':;::cll:::;llll:          'ol;,...';:odo:,....''...  ..,'''.
     ${BLUE}   ..';::..;;:lllll:;:clc,         :lolcc;;:col:cc:cc,''....  .  .....
     ${BLUE}   ...';lc..,::cccclccclc'      .'looododooxddxdlc:::::;,..  .'.. .',,
     ${BLUE}   ...',:cc'..';:::cccc:l:.    .cddxxddddxoodddlc::;;,,'....'',,'..,,,


		${RED}  Hacker clown [Sani kushwah]
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}Hacker0  ${RED}[ ${ORANGE}Sani kushwah ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/hacker0-a/
		${GREEN}Version  ${RED}:  ${ORANGE}2.2

		${REDBG}${WHITE} Thanks :EasyFish , clown Hacker0${RESETBG}
